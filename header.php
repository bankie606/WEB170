<!DOCTYPE html>
<!-- saved from url=(0046)http://ridethegrid.net/web200/final/events.php -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script src="js/buttonbackgroundchange.js"></script>
    </head>
...
<!--
 ...
 <li><a href="#">VIDEOWALL</a>
 </li>
 <li><a href="#">PARTNERS</a>
                  <ul>
            <li><a href="#">Past Partners</a></li>
